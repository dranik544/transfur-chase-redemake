...
@export var dialogs = [
	...
	["А не надо своих животных на меня натравливать!", "pl"],
	...
	["[color=#FF5555]Тебе мелкому знать не положено.[/color]", "tv"],
	["Тогда я сам узнаю, и они меня не остановят.", "pl"],
	
	["Не советую идти дальше...", "tv"],
	["Хотя, зная тебя, ты все равно пойдешь,", "tv"],
	["так что просто будь готов к маленьким неприятностям.", "tv"],
	["Сам решил выйти и мне по лбу надавать?", "pl"],
	
	["Зачем? В комплексе достаточно способов дистанционно тебе нагадить.", "tv"],
	["Зачем ты пытаешься меня остановить?", "pl"],
	["Что, страшно, что я твое наглое лицо разобью?", "pl"],
	
	["ТЫ?", "tv"],
	["МНЕ?", "tv"],
	["ХА! ХА! ХА! Как смешно.", "tv"],
	["Уверен, ты не пройдешь
	и десяти комнат дальше.", "tv"],
	["[pulse]Тихо[/pulse]: если, конечно,
	этот гандон не вмешается)", "tv"],
	["Кто, кто?", "pl"],
	
	["Так, все, хватит этой болтовни.", "tv"],
	["Либо ты идешь к тем латексным,
	либо тебя сожрут в следующей комнате.", "tv"],
	["Выбирай.", "tv"],
	...
	["[rainbow]Что могу сказать, можешь попытаться.[/rainbow]", "tv"],
